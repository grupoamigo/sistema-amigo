    ...
    return (
      <div>
        <h2 id="client-heading">
          <Translate contentKey="sistemaAmigoApp.client.home.title">Clients</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="sistemaAmigoApp.client.home.createLabel">Create a new Client</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('sistemaAmigoApp.client.home.search')}
                  />
        ...
        <div className="table-responsive">
          {clientList && clientList.length > 0 ? (
              ...
              <tbody>
                {clientList.map((client, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>
                      <Translate contentKey={`sistemaAmigoApp.ClientStatusType.${client.status}`} />
                    </td>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="sistemaAmigoApp.client.home.notFound">No Clients found</Translate>
            </div>
          )}
        </div>
      </div>
