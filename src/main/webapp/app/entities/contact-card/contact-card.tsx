...
import { getSearchEntities, getEntities } from './contact-card.reducer';
    ...
    return (
      <div>
        <h2 id="contact-card-heading">
          <Translate contentKey="sistemaAmigoApp.contactCard.home.title">Contact Cards</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="sistemaAmigoApp.contactCard.home.createLabel">Create a new Contact Card</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('sistemaAmigoApp.contactCard.home.search')}
                  />
        ...
        <div className="table-responsive">
          {contactCardList && contactCardList.length > 0 ? (
            <Table responsive aria-describedby="contact-card-heading">
              <thead>
                <tr>
                  <th>
              ...
              <tbody>
                {contactCardList.map((contactCard, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>
                      <Translate contentKey={`sistemaAmigoApp.ContactType.${contactCard.type}`} />
                    </td>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="sistemaAmigoApp.contactCard.home.notFound">No Contact Cards found</Translate>
            </div>
          )}
        </div>
      </div>
