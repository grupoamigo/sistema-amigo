...
import { getSearchEntities, getEntities } from './route.reducer';
...
export class Route extends React.Component<IRouteProps, IRouteState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="route-heading">
          <Translate contentKey="sistemaAmigoApp.route.home.title">Routes</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="sistemaAmigoApp.route.home.createLabel">Create a new Route</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('sistemaAmigoApp.route.home.search')}
                  />
        ...
        <div className="table-responsive">
          {routeList && routeList.length > 0 ? (
            <Table responsive aria-describedby="route-heading">
              <thead>
                <tr>
                  <th>
              ...
              <tbody>
                {routeList.map((route, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{route.name}</td>
                    <td>
                      <Translate contentKey={`sistemaAmigoApp.CurrencyType.${route.currency}`} />
                    </td>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="sistemaAmigoApp.route.home.notFound">No Routes found</Translate>
            </div>
          )}
        </div>
      </div>
