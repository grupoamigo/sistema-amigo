...
export class InspectionDeleteDialog extends React.Component<IInspectionDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.inspectionEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="sistemaAmigoApp.inspection.delete.question">
          <Translate contentKey="sistemaAmigoApp.inspection.delete.question" interpolate={{ id: inspectionEntity.id }}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-inspection" color="danger" onClick={this.confirmDelete}>
