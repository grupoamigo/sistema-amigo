    ...
    return (
      <div>
        <h2 id="state-code-heading">
          <Translate contentKey="sistemaAmigoApp.stateCode.home.title">State Codes</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="sistemaAmigoApp.stateCode.home.createLabel">Create a new State Code</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('sistemaAmigoApp.stateCode.home.search')}
                  />
        ...
        <div className="table-responsive">
          {stateCodeList && stateCodeList.length > 0 ? (
            ...
            <div className="alert alert-warning">
              <Translate contentKey="sistemaAmigoApp.stateCode.home.notFound">No State Codes found</Translate>
            </div>
          )}
        </div>
      </div>
