...
import { getSearchEntities, getEntities } from './country-code.reducer';
...
export class CountryCode extends React.Component<ICountryCodeProps, ICountryCodeState> {
  state: ICountryCodeState = {
    search: ''
  };
    ...
    return (
      <div>
        <h2 id="country-code-heading">
          <Translate contentKey="sistemaAmigoApp.countryCode.home.title">Country Codes</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="sistemaAmigoApp.countryCode.home.createLabel">Create a new Country Code</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('sistemaAmigoApp.countryCode.home.search')}
                  />
        ...
        <div className="table-responsive">
          {countryCodeList && countryCodeList.length > 0 ? (
            <Table responsive aria-describedby="country-code-heading">
              <thead>
                <tr>
                  <th>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="sistemaAmigoApp.countryCode.home.notFound">No Country Codes found</Translate>
            </div>
          )}
        </div>
      </div>
