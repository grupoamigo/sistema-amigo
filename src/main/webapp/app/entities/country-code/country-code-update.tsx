    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="sistemaAmigoApp.countryCode.home.createOrEditLabel">
              <Translate contentKey="sistemaAmigoApp.countryCode.home.createOrEditLabel">Create or edit a CountryCode</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
