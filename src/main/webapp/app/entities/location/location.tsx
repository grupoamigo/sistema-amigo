    ...
    return (
      <div>
        <h2 id="location-heading">
          <Translate contentKey="sistemaAmigoApp.location.home.title">Locations</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="sistemaAmigoApp.location.home.createLabel">Create a new Location</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('sistemaAmigoApp.location.home.search')}
                  />
        ...
        <div className="table-responsive">
          {locationList && locationList.length > 0 ? (
              ...
              <tbody>
                {locationList.map((location, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{location.lng}</td>
                    <td>
                      <TextFormat type="date" value={location.timestamp} format={APP_DATE_FORMAT} />
                    </td>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="sistemaAmigoApp.location.home.notFound">No Locations found</Translate>
            </div>
          )}
        </div>
      </div>
