...
import { getSearchEntities, getEntities } from './extra-field.reducer';
...
export interface IExtraFieldState {
  search: string;
}

export class ExtraField extends React.Component<IExtraFieldProps, IExtraFieldState> {
  state: IExtraFieldState = {
    search: ''
  };
    ...
    return (
      <div>
        <h2 id="extra-field-heading">
          <Translate contentKey="sistemaAmigoApp.extraField.home.title">Extra Fields</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="sistemaAmigoApp.extraField.home.createLabel">Create a new Extra Field</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('sistemaAmigoApp.extraField.home.search')}
                  />
        ...
        <div className="table-responsive">
          {extraFieldList && extraFieldList.length > 0 ? (
            <Table responsive aria-describedby="extra-field-heading">
              <thead>
                <tr>
                  <th>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="sistemaAmigoApp.extraField.home.notFound">No Extra Fields found</Translate>
            </div>
          )}
        </div>
      </div>
