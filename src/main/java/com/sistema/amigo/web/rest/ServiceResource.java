...
import com.sistema.amigo.repository.ServiceRepository;
import com.sistema.amigo.repository.search.ServiceSearchRepository;
...
/**
 * REST controller for managing {@link com.sistema.amigo.domain.Service}.
 */
@RestController
@RequestMapping("/api")
